...
<p>{{ Lang::get('confide::confide.email.password_reset.greetings', array( 'name' => $user->full_name )) }}!</p>
...
<p>{{ Lang::get('confide::confide.email.password_reset.farewell') }}, <br> Rubik klub Slovenija</p>
